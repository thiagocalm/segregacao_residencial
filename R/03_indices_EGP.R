...
save(resultados_D_index_2000, file = "./output/EGP/resultados_D_indice_2000.RData")
save(resultados_D_index_2010, file = "./output/EGP/resultados_D_indice_2010.RData")
save(resultados_QL_index_2000, file = "./output/EGP/resultados_QL_indice_2000.RData")
save(resultados_QL_index_2010, file = "./output/EGP/resultados_QL_indice_2010.RData")
